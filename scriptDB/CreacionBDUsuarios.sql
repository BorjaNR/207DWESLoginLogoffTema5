...
DROP DATABASE IF EXISTS DB207DWESLoginLogoffTema5;

DROP USER IF EXISTS 'user207DWESLoginLogoffTema5'@'%';

--Crear la base de datos
CREATE DATABASE DB207DWESLoginLogoffTema5;
...
CREATE USER 'user207DWESLoginLogoffTema5'@'%' IDENTIFIED BY 'paso';

--Otorgar permisos al usuario para acceder a la base de datos
GRANT ALL PRIVILEGES ON DB207DWESLoginLogoffTema5.* TO 'user207DWESLoginLogoffTema5'@'%';